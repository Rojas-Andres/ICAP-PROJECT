...
class CustomUser(AbstractUser):
	...
	matricula = models.CharField('Matrícula', max_length=4, unique=True)
	...
	num_ruc = models.CharField('Número de RUC', max_length=10, null=True, blank=True)
	...
	ejer_cated = models.CharField('Ejercicio en la Cátedra', max_length=50, null=True, blank=True)
...
class RegistrarUsuario(models.Model):
	...
	matricula = models.CharField('Matrícula', max_length=4)
