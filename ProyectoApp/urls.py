...
urlpatterns = [
	...
	path('recaudadorcobrarconfdatos/<user_log>/<usuario><int:ta>/<talon>/<fecha_pago>/<etiq>/', login_required(views.RecaudadorCobroConfirmarDatos.as_view()), name='recaudador-cobro-confirmar-datos'),
	...
	path('recaudadorcobromultefect/<user_log>/<usuario>/<fecha_pago>/<int:cant>/<tam>/<talon>/', login_required(views.RecaudadorCobroMultipleEfect.as_view()), name='recaudador-cobro-multiple-efect'),
