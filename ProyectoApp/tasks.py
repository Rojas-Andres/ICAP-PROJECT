...
def cobrar_aporte_confirmado(request, user_log, usuario, ta, talon, fecha_pago, etiq):
...
def cobrar_aporte_mult(request, user_log, usuario, fecha_pago, cant, tam, talon):
	user_log = CustomUser.objects.get(username=user_log)
	usuario = CustomUser.objects.get(username=usuario)
